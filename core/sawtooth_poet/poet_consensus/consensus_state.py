...
#TODO add the states from giskard structure.v NState
ValidatorState = \
...
#    def prepare_stage_in_view(nstate, view, block):
    ...
    def prepare_stage(block, nstate):
        any(v_i <= nstate.node_view for v_i in prepare_stage_in_view(block,nstate))
